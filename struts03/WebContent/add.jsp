...
<body>
	...
	<div class="btn-group btn-group-justified" role="group"
		aria-label="...">
		<a class="btn btn-default btn-block" href="./index.action"
			role="button">HOME</a> <a class="btn btn-default btn-block"
			href="./intro.action" role="button">INTRO</a> <a
			class="btn btn-primary btn-block" href="./list.action" role="button">BBS</a>
		<a class="btn btn-default btn-block" href="./login.action"
			role="button">LOGIN</a>
	</div>
